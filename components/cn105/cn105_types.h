...
static const uint8_t SUB_MODE[8] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x08, 0x0F, 0x40 };
static const char* SUB_MODE_MAP[8] = { "0 NORMAL", "1", "2 DEFROST", "3 PREHEAT", "4 STANDBY", "8", "16","64" };
