...
static const uint8_t SUB_MODE[9] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x08, 0x0F, 0x40 };
static const char* SUB_MODE_MAP[9] = { "0 NORMAL", "1 STANDBY", "2 ???", "3 ???", "4 STANDBY", "5 PREHEAT, "8", "16","64" };
